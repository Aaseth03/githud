...
| The generated art cannot be cleanly separated into parts with occluded regions filled, making the Live2D upgrade path fictional | Prove it on **one** character by hand in phase 6, before M8 automates anything. If occlusion fill turns out to be impractical, that is a D21 amendment and better found now than after five characters exist |
