...
**3D landed 2026-08-06 as the `vrm` type** ([D29](decisions/2026-08-06-D29-vrm-is-the-3d-character-type.md)):
...
- [x] 3D type: `Sprite::Vrm`, a `.vrm` validated by its bytes and version-stamped
      at import, a shared `.vrma` clip library, and its own suite (D29)
- [x] A clip generator for the ambient loops — ~20 sliders, live preview on the
      ...
      (D32). Authoring only; the render loop still plays nothing but keyframes.
