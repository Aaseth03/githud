...
| D28 | [`vrm` is the 3D character type](decisions/2026-08-06-D28-vrm-is-the-3d-character-type.md) — a VRoid model posed by shared `.vrma` clips, with its own motion model; commits the 3D candidate M10 left open |
