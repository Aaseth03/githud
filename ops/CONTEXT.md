...
|---|---|---|
| `scripts/create-private-remote.sh` | Creates a private GitHub repo for a local directory and pushes the first commit | Bringing a new project into `~/github`; also the M9 new-project flow |
